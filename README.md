...
It has itself a representation in the nanopublication system: [https://w3id.org/spaces/knowledgepixels/incubator/project2](https://w3id.org/spaces/knowledgepixels/incubator/project2).
